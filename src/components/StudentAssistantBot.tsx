  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      sender: 'bot',
      text: 'مرحباً بك يا بطل! أنا المساعد الأكاديمي الذكي لمادة الأحياء. كيف يمكنني مساعدتك اليوم في فهم الدروس، شرح الرسومات التشريحية، أو مراجعة أسئلة الشهادة السودانية السابقة؟ 🧬',
      timestamp: new Date()
    }
  ]);
